...
let
  ...
  appName = "ProtonVPN"; # The name of the .app bundle, e.g., "VLC.app"
  pname = "protonvpn"; # Lowercase package name
  version = "4.8.0";       # Version of the application

  # URL for the DMG file
  dmgUrl = "https://vpn.protondownload.com/download/macos/4.8.0/ProtonVPN_mac_v4.8.0.dmg";
